...
const seed = { version: 1, settings: { startDate: '2026-06-08', schedule: 'everyOtherDay', exercises: [{ id: 'pushups', name: 'Armhävningar', reps: 10, sets: 3 }, { id: 'squats', name: 'Squats', reps: 10, sets: 3 }] }, log: { '2026-06-08': { pushups: 3, squats: 3 }, '2026-06-10': { pushups: 3, squats: 3 }, '2026-06-12': { pushups: 3, squats: 3 }, '2026-06-16': { pushups: 3, squats: 3 }, '2026-06-18': { pushups: 3, squats: 3 }, '2026-06-20': { pushups: 3, squats: 3 }, '2026-06-22': { pushups: 3, squats: 3 }, '2026-06-24': { pushups: 3, squats: 3 }, '2026-06-26': { pushups: 2, squats: 1 } } };
